...
**目前正式發布基準為 v0.7.0**：工作包 012 已發布人機對弈獨立設定頁，首頁、漢堡選單與功能指南都會進入同一頁；正式根網址與 Service Worker 已設為 no-cache。25 個 test files／196 tests、production build、320／390／640 px 與正式站流程通過。校準資料仍只存目前電腦／瀏覽器，不代表已具真人棋風或對應台灣段級，也不會自動改寫公開難度。
