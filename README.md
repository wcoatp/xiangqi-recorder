...
**目前發布基準為 v0.6.0**：工作包 010 已發布段級校準 schema v2、安全匯入與版本隔離統計；23 個 test files／179 tests、production build、正式站版本與引擎載入通過。校準入口仍只存本機並由 PIN 保護；v0.6.0 尚未開放校準對弈，也不代表已具真人棋風或對應台灣段級。
