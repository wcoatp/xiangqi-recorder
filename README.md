...
目前原始碼工作目錄中的**工作包 008（完整本機備份 v2）已完成本機驗證、尚待發布**：17 個 test files／123 tests、桌面流程及 320／390／640 px 響應式驗收皆通過；commit、push、Firebase deploy 與正式站驗證尚未完成。因此正式站在發布完成前仍可能是上一版。
