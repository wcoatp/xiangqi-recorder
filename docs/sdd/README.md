...
| 014 | [iPad 對弈棋盤首次直向排版穩定化](014-ipad-play-board-first-layout.md) | Released | `d5102bd` | 2026-07-17 / [正式站](https://xiangqi-recorder.web.app/) | 移除對弈棋盤 `56vh`、採容器驅動尺寸與明確 SVG 比例；25 個 test files／196 tests、build、320～1180px 冷進／旋轉／點棋及正式站驗證通過，待同一台 iPad Air 補測。 |
...
| 018 | [固定展開的解棋對照工作台](018-always-open-analysis-workspace.md) | Released | `f5baae8` | 2026-07-19 / [正式站](https://xiangqi-recorder.web.app/) | v0.10.0 移除直向三段面板控制，改為固定展開、內容獨立捲動並保留大棋盤與寬橫向雙欄；30 個 test files／227 tests、真實引擎、320～1366 px 與正式站通過。 |
| 019 | [棋盤座位方向與復盤視角控制](019-board-orientation-controls.md) | Released | `748598b` | 2026-07-21 / [正式站](https://xiangqi-recorder.web.app/) | v0.11.0 記譜可即時切換同向／對向，復盤與解棋可切換紅／黑方在下；本機保存、不改棋譜或備份 v2，31 個 test files／231 tests、兩方向點棋、320～1366 px 與正式站通過。 |
