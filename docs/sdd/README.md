...
| 019 | [棋盤座位方向與復盤視角控制](019-board-orientation-controls.md) | Verified | 待建立 | 待發布 | v0.11.0 記譜可即時切換同向／對向，復盤與解棋可切換紅／黑方在下；本機保存、不改棋譜或備份 v2，31 個 test files／231 tests、兩方向點棋與 320～1366 px 通過。 |
