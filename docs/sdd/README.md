...
| 011 | [PIN 內現場校準對弈控制器](011-calibration-match-controller.md) | Verified | 待建立 | 待部署 | fixed-nodes／seeded MultiPV 現場局、偶紅奇黑、逐著 CAS、中斷續存、跨版本保護與人工規則裁定；25 test files／196 tests 與 production build 通過。 |
