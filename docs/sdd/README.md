...
| 013 | [iPad 全視窗響應式版面](013-ipad-full-viewport-layout.md) | Verified | — | 待發布 | App shell 於 320～1366px 使用完整 viewport，iPad 首頁四欄、內容局部限寬且 manifest 不鎖方向；25 個 test files／196 tests、build、九組 viewport 與主要導覽流程通過。 |
